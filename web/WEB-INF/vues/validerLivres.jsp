                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-sm">
                                ...
                                %>
                                <tr>
                                    <td><button class="form-control-sm" onclick="window.location.href='<%=livre.getImage()%>'"><img height="100%" src="./static/open-iconic/svg/image.svg"/></button></td>
                                    ...
                                    <td><a href="?ac=validerAnnonce&action=valider&id=<%=livre.getId()%>">Valider</a></td>
                                    <td><a href="?ac=validerAnnonce&action=supprimer&id=<%=livre.getId()%>">Supprimer</a></td>
                                </tr>
                                <% } %>
