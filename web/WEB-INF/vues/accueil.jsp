                ...
                <div class="row">
                    <div class="col-lg-3 cold-md-6 text-center">
                            <div class="mt-5">
                                ...
                                <h3 class="h4 mb-2"><%=livre1.getTitre()%></h3>
                                <p class="text-muted mb-0"><%=livre1.getAuteur()%></p>
                            </div>
                    </div>
                    <div class="col-lg-3 cold-md-6 text-center">
                            <div class="mt-5">
                                <img style="max-height: 250px" style="max-width: 100px" src=<%=livre2.getImage()%> alt="">
                                <h3 class="h4 mb-2"><%=livre2.getTitre()%></h3>
                                <p class="text-muted mb-0"><%=livre2.getAuteur()%></p>
                            </div>
                    </div>
                    <div class="col-lg-3 cold-md-6 text-center">
                            <div class="mt-5">
                                <img style="max-height: 250px" style="max-width: 100px" src=<%=livre3.getImage()%> alt="">
                                <h3 class="h4 mb-2"><%=livre3.getTitre()%></h3>
                                <p class="text-muted mb-0"><%=livre3.getAuteur()%></p>
                            </div>
                    </div>
                    <div class="col-lg-3 cold-md-6 text-center">
                            <div class="mt-5">
                                <img style="max-height: 250px" style="max-width: 100px" src=<%=livre4.getImage()%> alt="">
                                <h3 class="h4 mb-2"><%=livre4.getTitre()%></h3>
                                <p class="text-muted mb-0"><%=livre4.getAuteur()%></p>
                            </div>
                    </div>
                </div>
            </div>
