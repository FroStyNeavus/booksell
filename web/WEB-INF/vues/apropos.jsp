        ...
        <section class="page-section" id="populaires">
            <div class="container h-100">
                ...
                <div class="pt-4 row">
                    <div class="col-3"></div>
                    <div class="col-6">
                        <div class="d-flex justify-content-center"><input class="btn-primary btn-xl" type="button" onclick="window.location.href='?ac=nav&page=signup'" value="Essayer-le"/></div>
                    </div>
                    <div class="col-3"></div>
                </div>
                </c:if>
