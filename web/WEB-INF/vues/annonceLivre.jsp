...
<html>
        ...
        <body>
            <section class="page-section" id="populaires">
                <div class="container"><br><br>
                    <h2 class="text-center mt-0">Aucune annonce trouvée pour le livre : <%=request.getParameter("titre")%></h2>
                </div>
            </section>
        </body>
        <%
    ...
    <body>
        <section class="page-section" id="populaires">
        <div class="container">
            <h2 class="text-center mt-0">Annonces pour le livre : <%=request.getParameter("titre")%> </h2><br><br>
                        ...
                        <td>
                            <table class="table table-borderless p-0 m-0">
                                <tr class="p-0 m-0" width="">
                                    <td width="100px" rowspan="4" class="p-0 m-0"><img height="100px" src=<%=annonce.getLivre().getImage()%> alt=""></td>
                                </tr>
                                <tr class="p-0 m-0">
                        ...
                        <td>
                            <table class="table table-borderless p-0 m-0">
                                <tr class="p-0 m-0">
                                    ...
                                    <td class="p-0 m-0">Nom: <a href="?ac=profil&pseudo=<%=utilisateurDAO.trouverParId(annonce.getAnnonce().getUtilisateurID()+"").getPseudo()%>"><%=utilisateurDAO.trouverParId(annonce.getAnnonce().getUtilisateurID()+"").getPseudo()%><br></td>
                                </tr>
                                <tr class="p-0 m-0">
                                    <td class="p-0 m-0">Courriel: <%=utilisateurDAO.trouverParId(annonce.getAnnonce().getUtilisateurID()+"").getCourriel()%><br></td>
                                </tr>
                                <tr class="p-0 m-0">
                                    
                                    <td class="p-0 m-0">Téléphone: <%=utilisateurDAO.trouverParId(annonce.getAnnonce().getUtilisateurID()+"").getTelephone()%><br></td>
                                </tr>
                            </table>
                        </td>
                        <td><%=annonce.getAnnonce().getPrix()%>$</td>
                        <td><%=annonce.getAnnonce().getEtat()%></td>
                    </tr>
            <%           
                    }
}
