...
<section class="page-section" id="populaires">
    <div class="container" align="center">
        ...
        <form id="categorie" method="get">
            ...
            <select style="text-align: center" id="categorie" class="form-control" name="categorie" onchange="this.form.submit()" autofocus>
                <%if(request.getParameter("categorie")!=null){%>
                <option selected disabled hidden><%=request.getParameter("categorie")%></option>
                <%
            }
            else{%>
        ...
        <c:if test="${not empty sessionScope.session}">
            <button onclick="window.location.href='?ac=nav&page=ajoutLivre'" class="btn btn-primary mt-5">Ajouter un livre</button>
        </c:if>
        <br>
                                ...
                                <div class="hover-contents">
                                    ...
                                    <div class="hover-btns "><br>
                                        ...
                                        <form method="get">
                                            ...
                                            <button name="titre" id="titre" class="btn-md btn-primary form-control m-2" value="<%=livre.getTitre()%>" type="submit">Créer une annonce</button>
                                            <input type="hidden" name="ext" value="redir">
                                        </form>
                                        <form method="get">
                                            <input type="hidden" name="ac" value="annonceLivre">        
                                            <button name="titre" id="titre" class="btn-md btn-primary form-control m-2" value="<%=livre.getTitre()%>" type="submit">Voir annonces de ce livre</button>
                                        </form>
                                        <%
                                            }
                                        %>
