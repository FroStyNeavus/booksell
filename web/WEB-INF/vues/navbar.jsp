            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <ul class="text-dark navbar-nav ml-auto my-2 my-lg-0">
                    ...
                    %>
                        ...
                        <li class="nav-item"><a class="text-dark nav-link js-scroll-trigger" href="?ac=validerAnnonce">Valider Livres</a>
                        </li>
                    <%
                    }
                    %>
                    <li class="nav-item"><a class="text-dark nav-link js-scroll-trigger" href="?ac=venteAnnonce">Annonce</a>
                        ...
                        <li class="nav-item"><a class="text-dark nav-link js-scroll-trigger" href="?ac=profil&pseudo=<%=user.getPseudo()%>">Profil</a>
                        </li>
