                ...
                <div class="card card-signin my-5">
                    <div class="card-body">
                        ...
                        <form class="form-signin" method="get">
                            <input type="text" id="inputPrix" name="prix" class="form-control m-2" placeholder="Prix" value="${requestScope.prix}" required autofocus>
                        <%
                            {
                        ...
                        %>
                            ...
                            <button class="btn btn-lg btn-primary btn-block text-uppercase m-2" value="OK" type="submit">Modifier</button>
                            <hr class="my-4">
                        </form>
                    </div>
                </div>
