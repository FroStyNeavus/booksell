        ...
        <div class="container">
            ...
            <div class="row bg-light">
                <form class="form-inline p-2 ">
                    ...
                    <input type="text"  name="nomlivre" class="form-control mr-4" placeholder="Nom du livre" value="${requestScope.nomlivre}">
                    ...
                    <tr>
                        ...
                        <td>
                            <form>
                                ...
                                <button type="submit" value="Modifier" class="btn-md btn-primary form-control">Modifier</input>
                            </form>
                            <a href="?ac=supprimerannonce&idannonce=<%=annonce.getAnnonce().getId()%>"><button class="btn-md btn-primary form-control my-2" type="button">Supprimer</button></a>
                        </td>
                    </tr>
            <%           
                    }
