                        ...
                        <div class="card-body">
                            ...
                            <form class="form-signin" method="get">
                                ...
                                <div class="form-label-group">
                                    <input type="text" id="username" name="pseudo" class="form-control"
                                ...
                                <div class="custom-control custom-checkbox mb-3">
                                    ...
                                    <label class="custom-control-label" for="customCheck1">Se souvenir de mon mot de
                                        passe</label>
                                </div>
                                <button class="btn btn-lg btn-primary btn-block text-uppercase" value=" OK "
                                        type="submit">Connecter
                                </button>
                                <button class="btn btn-lg btn-primary btn-block text-uppercase"
                                        onclick="window.location.href = '?ac=nav&page=signup';">Créer un compte
                                </button>
                                <hr class="my-4">
                            </form>
                        </div>
