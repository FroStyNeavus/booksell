                    ...
                    <c:if test="${not empty sessionScope.session}">
                        ...
                        <div class="card card-signin my-5">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-4"><img class="img-fluid" src="./static/img/default-profile.png"/>
                                    </div>
                                    <div td class="col-8">
                                        <div class="row">
                                            <div class="mb-0 pb-0 col-12 display-2"><c:out
                                                    value="${user.pseudo}"/></div>
                                            <div class="pl-2">
                                                <div class="mb-0 pb-0 col-12"><c:out value="${user.role}"/></div>
                                                <div class="col-12">Téléphone: <c:out value="${user.telephone}"/></div>
                                                <div class="col-12">Courriel: <a href="mailto:${user.courriel}"><c:out
                                                        value="${user.courriel}"/></a></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <c:if test="${sessionScope.session.id==user.id}">
                                        <div class="col-4 mt-2">
                                            <button class="form-control"
                                                    onclick="window.location.href='?ac=nav&page=profilModification'">
                                                Modifier le profil
                                            </button>
                                        </div>
                                    </c:if>
