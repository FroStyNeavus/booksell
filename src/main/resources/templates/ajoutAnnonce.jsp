                    ...
                    <div class="card-body">
                        ...
                        <form class="form-signin" method="get">
                            ...
                            <div>
                                ...
                                <label class="form-control" placeholder="Nom du livre"><%=nom%>
                                </label>
                            </div>
                            <%
                                {
                            ...
                            <div class="alert alert-warning" role="alert">
                                <strong><%=(String) request.getAttribute("ERREUR_ANNONCE_LIVRENULL")%>
                                </strong>
                            </div>
                            <%
                                    }
                            ...
                            <div>
                                <input type="text" id="inputPrix" name="prix" class="form-control"
                                       placeholder="Prix demandé" value="<%=prix%>" required>
                            </div>
                            <%
                                {
                            ...
                            %>
                            <div class="alert alert-warning" role="alert">
                                <strong><%=(String) request.getAttribute("ERREUR_DONNEE_NONNUMERIQUE")%>
                                </strong>
                            </div>
                            <%
                                    }
